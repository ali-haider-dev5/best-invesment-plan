...
const App = () => {
  return (
    ...
    <div className="container mx-auto mt-24">
      <h1 className="text-6xl text-center mb-24 font-bold ">About Mazco</h1>
      <div className=" flex p-4 justify-center">
        <div className="testimonial-container max-w-5xl w-full md:flex md:space-x-8 items-start">
          ...
          <div className="relative   rounded-lg flex-1 md:mb-0 mb-8">
            <div className="bg-[#d5eefa] p-8 md:p-12 rounded-tl-lg rounded-tr-lg rounded-bl-lg border-b-0 border-r-0 dark:bg-[#1f2938]">
              <blockquote className="relative z-10 text-xl md:text-2xl font-medium text-[#1e2939] dark:text-white leading-snug">
            ...
            <div className="flex">
              <div className="flex items-center ">
                <div className="bg-[#d5eefa] dark:bg-[#1f2938] rounded-tl-[35px] rounded-bl-[35px] rounded-br-[35px]">
                  <svg
                    width="230"
                    height="174"
                    viewBox="0 0 230 174"
              ...
              <div className="flex flex-col bg-[#d5eefa] dark:bg-[#1f2938] w-full rounded-bl-lg rounded-br-lg  border-t-0 p-4">
                ...
                <div className="mt-8 flex flex-col md:flex-row md:items-center justify-end space-y-4 md:space-y-0 items-end">
                  <a
                    href="#"
                    className="px-6 py-3 bg-[#0185c7] text-white text-sm font-semibold rounded-full shadow-lg hover:bg-gray-700 transition-colors duration-300"
                  >
