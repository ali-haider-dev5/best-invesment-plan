  ...
  return (
    <div className="bg-[#f6fafc] dark:bg-[#1a2332] py-16 flex items-center justify-center p-8">
      <div className="text-center">
        ...
        <button className="mt-8 px-8 py-4 bg-[#f4a950] text-white font-semibold rounded-full shadow-lg transition-transform transform hover:scale-105 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 focus:ring-offset-lime-300">
          Request a demo
        </button>
      </div>
    </div>
