...
const HeroSection = () => {
  return (
    <div className="min-h-screen w-screen bg-gradient-to-br dark:bg-[#1f2937] dark:from-[#1f2937] dark:to-[#1f2937] from-[#f6fafc] to-[#0ea5e9]  text-white flex flex-col items-center justify-center p-8">
      <div className="w-full max-w-6xl space-y-12 relative z-10">
        <div className="flex flex-col items-center text-center space-y-8">
          ...
          <div className="space-y-6 flex items-center justify-center flex-col ">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              <Button className="text-sm px-8 py-3 rounded-xl bg-[var(--brand)] text-[#ffffff] border border-white/10 shadow-none hover:bg-[var(--brand-dark)] transition-all">
                Get Started
              </Button>
              <Button className="text-sm px-8 py-3 rounded-xl bg-transparent text-white border border-white/20 shadow-none hover:bg-white/10 transition-all">
                Learn More
              </Button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="backdrop-blur-sm bg-[#0ea5e9] border border-white/10 rounded-xl p-4 md:p-6 h-40 md:h-48 flex flex-col justify-start items-start space-y-2 md:space-y-3"
            >
